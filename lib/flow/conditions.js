...
function onConditionHttpGet (callback, args) {
  util.genericRequestHelper('condition.http_get', 'get', args, null)
...
function onConditionHttpGetJson (callback, args) {
  ...
  util.genericRequestHelper('condition.http_get_json', 'get', args, {query: data})
    .then(result => { callback(null, result.response.statusCode === args.status_code) })
    .catch(callback)
}
...
function onConditionHttpGetVariable (callback, args) {
  ...
  util.genericRequestHelper('condition.http_get_variable', 'get', args, {query: data, json: false})
