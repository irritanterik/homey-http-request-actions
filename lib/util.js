...
exports.genericRequestHelperXml = function (flow, defaultMethod, args, mergeOptions, xmlString) {
  var self = this
  var method = defaultMethod
  var urlOptions = createUrlOptions(args.url, mergeOptions)
  if (urlOptions.method) method = urlOptions.method.toLowerCase()
  self.debugLog(flow, {args: args, method: method, urlOptions: urlOptions, xmlString: xmlString})
  return http[method](urlOptions, xmlString)
} // function genericRequestHelperXml
